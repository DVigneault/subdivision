...
# Bezier stuff
# bspline_to_bezier_conversion_matrix
def bspline_to_bezier_conversion(N):

    # Matrices
    A = extended_subdivision_matrix(N)
    B = bigger_subdivision_matrix(N)

    # Calculate Eigenvalues/Eigenvectors
    val = np.asarray(extended_subdivision_eigenvalues(N))
    R = np.asarray(extended_subdivision_eigenvectors(N))
    ...
    components[1,:] = recursive_evaluate(0,
                                         triangle_bspline_position_basis,
                                         N,
                                         (1,0))
    ...
    components[2,:] = recursive_evaluate(0,
                                         triangle_bspline_position_basis,
                                         N,
                                         (0,1))
    ...
    components[3,:] = recursive_evaluate(0,
                                         triangle_bspline_position_basis,
                                         N,
                                         (0.5,0.0))
    ...
    components[4,:] = recursive_evaluate(0,
                                         triangle_bspline_position_basis,
                                         N,
                                         (0.5,0.5))
    ...
    components[5,:] = recursive_evaluate(0,
                                         triangle_bspline_position_basis,
                                         N,
                                         (0.0,0.5))
    ...
    components[6,:] = recursive_evaluate(0,
                                         triangle_bspline_position_basis,
                                         N,
                                         (1./3,1./3))
...
#    print "vt.dot(sub)", vt.dot(sub) # vt.dot(sub) [[-2.598  1.5  ]]
    ...
    Xt = recursive_evaluate(1,
                            triangle_bezier_dt_basis,
                            N,
                            (1.0, 0.0))

    Xs = recursive_evaluate(1,
                            triangle_bezier_ds_basis,
                            N,
                            (1.0, 0.0))
    ...
    bspline_to_bezier = weights.dot(components)

    return bspline_to_bezier
